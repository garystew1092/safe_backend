...
const registerUser = async(req, res) => {
    try {
        ...
        const welcomeMessage = await Message.create({
            subject: "Welcome to Grant Trust Security",
            message: `Welcome ${user.firstname} ${user.lastname}, you have successfully registered as a ${user.role}.
    Thank you for choosing Grant Trust Security — your safety is our priority. We're excited to have you on board!`,
            sender: sandra._id, // ✅ correct ObjectId
            recipient: user._id,
        });
